...
import (
	...
	"github.com/iitheorepo/bookings/internal/models"
...
// AvailabilityJSON hanldes request for availability and send JSON response
func (m *Repository) AvailabilityJSON(w http.ResponseWriter, r *http.Request) {
	data := jsonResponse{OK: true, Message: "Post request!"}
